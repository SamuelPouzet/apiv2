 ...
 */
final class Version20241212172022 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $table->addColumn('login', 'string', ['notnull'=>true, 'lenght'=>255]);
        $table->addColumn('password', 'string', ['notnull'=>true, 'lenght'=>255]);
        $table->addColumn('mail', 'string', ['notnull'=>true, 'lenght'=>250]);
        ...
        $table->addColumn('id', 'integer', ['unsigned'=>true, 'autoincrement'=>true]);
        $table->addColumn('name', 'string', ['notnull'=>true, 'lenght'=>100]);
        $table->addColumn('code', 'string', ['notnull'=>true, 'lenght'=>200]);
        $table->setPrimaryKey(['id']);
        $table->addOption('engine' , 'InnoDB');
        ...
        $table->addColumn('id', 'integer', ['unsigned'=>true, 'autoincrement'=>true]);
        $table->addColumn('user_id', 'integer', ['notnull'=>true]);
        $table->addColumn('auth_token', 'string', ['notnull'=>true, 'lenght'=>250]);
        ...
        $table->addColumn('id', 'integer', ['unsigned'=>true, 'autoincrement'=>true]);
        $table->addColumn('user_id', 'integer', ['notnull'=>true]);
        $table->addColumn('refresh_token', 'string', ['notnull'=>true, 'lenght'=>250]);
        $table->addColumn('creation_date', 'datetime', ['notnull'=>true]);
        $table->setPrimaryKey(['id']);
        $table->addOption('engine' , 'InnoDB');
    }
